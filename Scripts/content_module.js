import {WinOpenUrl} from './windowHandler.js'
  ...
  setTimeout(() => {
    ...
    SideBar.insertAdjacentHTML('beforeend', `<li ng-repeat="item in menuitems" ng-class="{
      ...
      <a id="menu-test">
        ...
        <span ng-bind="item.title" class="caption ng-binding ng-scope" ng-if="item.title !== 'OPP' &amp;&amp; item.title !== 'ELO'">Change Theme</span>
      </a>
      <!-- ngIf: item.children -->
    </li>`);
    ...
    const Elem2 = this.document.getElementById('menu-test-2')
    ...
    Elem2.addEventListener('click', event => {
      ...
      WinOpenUrl("Youtube", "https://www.youtube.com/embed/dQw4w9WgXcQ")
      // if(!Menu) {
      //   let Modal = document.createElement('div')
      //   Modal.innerHTML = `
      //   <div class="modal">
      //     <div class="modal-header">
      //       <div class="title">Magister++ Settings</div>
      //       <button>&times;</button>
      //     </div>
      //     <div class="modal-body">
      //       Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam eius
      //       maiores ea corrupti voluptatum deleniti repellendus. Alias sapiente
      //       dolorem eos quos voluptatibus vitae, inventore id earum aliquid impedit
      //       numquam odio.
      //     </div>
      //   </div>
      // <div id="overlay"></div>`
